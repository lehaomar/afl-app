const tabs = [
  {
    ...
    label: 'Все игры',
    icon: (active) => (
      <svg className={`w-6 h-6 ${active ? 'text-green-400' : 'text-gray-500'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        {tabs.map((tab) => {
          ...
          return (
            ...
            >
              ...
              {active && (
                <div className="absolute bottom-0 h-0.5 w-10 bg-green-400 rounded-t" />
              )}
            </button>
          );
        })}
